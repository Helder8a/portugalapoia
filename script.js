...
// ===== INICIO DE LA LÓGICA PARA EL BLOG CON PAGINACIÓN =====

// Nos aseguramos de que este código solo se ejecute en la página del blog
// verificando si el contenedor #blog-posts existe.
if (document.getElementById('blog-posts')) {
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        const POSTS_PER_PAGE = 9; // Muestra 9 posts a la vez
        let currentPage = 1;
        let allPosts = []; // Para almacenar todos los posts
        ...
        fetch('_dados/blog.json')
            ...
            .then(data => {
                allPosts = data.posts.reverse(); // Los más nuevos primero
                
                if (allPosts.length > 0) {
                    loadPosts(); // Carga el primer lote
                } else {
            ...
            .catch(error => {
                ...
                postsContainer.innerHTML = '<p>Hubo un error al cargar el contenido.</p>';
            });
...
// ===== FIN DE LA LÓGICA PARA EL BLOG CON PAGINACIÓN =====