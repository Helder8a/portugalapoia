...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    carregarConteudo('/_dados/doacoes.json', 'announcements-grid', renderDoacao);
    carregarConteudo('/_dados/empregos.json', 'jobs-grid', renderEmprego);
    carregarConteudo('/_dados/servicos.json', 'services-grid', renderServico);
    carregarConteudo('/_dados/habitacao.json', 'housing-grid', renderHabitacao);

    // Llama a la función para actualizar los contadores
