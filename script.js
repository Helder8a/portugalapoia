        ...
        fetch('/_dados/blog.json')
            ...
            .then(data => {
                ...
                const renderBlogPost = (post) => {
                    ...
                    // Genera srcset para imágenes adaptables
                    const imageSrcset = `${imageUrl} 200w, ${imageUrl.replace(/\.avif/, '_medium.avif')} 600w, ${imageUrl.replace(/\.avif/, '_large.avif')} 1200w`;
                    const imageSizes = "(max-width: 600px) 200px, (max-width: 1200px) 600px, 1200px";

                    return `
                    <div class="col-lg-4 col-md-6 mb-4 blog-post-item" data-category="${post.category}">
                        <div class="blog-post-card">
                            <img class="card-img-top" src="${imageUrl}" srcset="${imageSrcset}" sizes="${imageSizes}" alt="${post.title}" loading="lazy">
                            <div class="card-body">
